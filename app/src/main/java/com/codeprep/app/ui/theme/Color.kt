...
val CardinalRedDark = Color(0xFFEA2B2B)
val SunYellow = Color(0xFFFFC800)
val SunYellowDark = Color(0xFFD9AA00)
val LockedGrey = Color(0xFFE5E5E5)
val LockedGreyDark = Color(0xFFAFAFAF)
val TextDark = Color(0xFF4B4B4B)
